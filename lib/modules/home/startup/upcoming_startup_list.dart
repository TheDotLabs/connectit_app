...
class UpcomingStartupList extends StatelessWidget {
  ...
  Stream<List<Startup>> _getStream() {
    return injector<Firestore>().collection(Constants.startupsCollection).where(Constants.isUpcoming, isEqualTo: true).snapshots().transform(streamTransformer);
  }
}
