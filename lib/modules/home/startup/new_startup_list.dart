...
class NewStartupList extends StatelessWidget {
  ...
  Stream<List<Startup>> _getStream() {
    return injector<Firestore>().collection(Constants.startupsCollection).where(Constants.isNew, isEqualTo: true).snapshots().transform(streamTransformer);
  }
}
