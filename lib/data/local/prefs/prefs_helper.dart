...
class SharedPrefsHelper {
  ...
  static const String PREFS_COMPANY_SELECTION_LIST = "globaladminusercompanyselectionlist";
  ...
  set companySelectionList(value) => _prefs.setString(PREFS_COMPANY_SELECTION_LIST, value);

  String get companySelectionList => _prefs.getString(PREFS_COMPANY_SELECTION_LIST);
  ...
  set lastVisitItemList(value) => _prefs.setStringList(PREFS_LAST_VISIT_ITEM_LIST, value);

  List<String> get lastVisitItemList => _prefs.getStringList(PREFS_LAST_VISIT_ITEM_LIST);
